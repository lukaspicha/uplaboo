<?php
// source: C:\xampp\htdocs\uplaboo\app\presenters/templates/@layout.latte

class Template78f794ed377e19854114dd50647c553e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a03acbf680', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lba113fcb8fd_head')) { function _lba113fcb8fd_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb1ace242140_scripts')) { function _lb1ace242140_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
