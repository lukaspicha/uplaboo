<?php
// source: C:\xampp\htdocs\uplaboo\app\presenters/templates/Homepage/default.latte

class Templatedc774a97bf02a1a1e6a73e1c7bbbdb3d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('cd8fc8696a', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb7ab5792b3d_content')) { function _lb7ab5792b3d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbee9bf6385f_title')) { function _lbee9bf6385f_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd0fc575045_scripts')) { function _lbd0fc575045_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb0bbfd800ba_head')) { function _lb0bbfd800ba_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
