<?php
// source: C:\xampp\htdocs\uplaboo\app/config/config.neon 
// source: C:\xampp\htdocs\uplaboo\app/config/config.local.neon 

class Container_84d4dd5709 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\ApiRouterPresenter' => array(array('application.1')),
			'App\Presenters\BasePresenter' => array(array('application.2', 'application.4')),
			...
			'App\ResourcesModule\Presenters\ApiRouterPresenter' => array(array('application.5')),
			'NetteModule\ErrorPresenter' => array(array('application.6')),
			'NetteModule\MicroPresenter' => array(array('application.7')),
			'Ublaboo\ApiRouter\DI\ApiRoutesResolver' => array(1 => array('apiRouter.resolver')),
		...
		'services' => array(
			...
			'apiRouter.resolver' => 'Ublaboo\ApiRouter\DI\ApiRoutesResolver',
			'application.1' => 'App\Presenters\ApiRouterPresenter',
			...
			'application.5' => 'App\ResourcesModule\Presenters\ApiRouterPresenter',
		...
		'tags' => array(
			'run' => array('apiRouter.resolver' => TRUE),
			'inject' => array(
				'application.1' => TRUE,
				'application.2' => TRUE,
				'application.3' => TRUE,
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\uplaboo\app',
			'wwwDir' => 'C:\xampp\htdocs\uplaboo\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\uplaboo\app/../temp',
		));
	}
	...
	/**
	 * @return Ublaboo\ApiRouter\DI\ApiRoutesResolver
	 */
	public function createServiceApiRouter__resolver()
	{
		$service = new Ublaboo\ApiRouter\DI\ApiRoutesResolver;
		$service->prepandRoutes($this->getService('routing.router'), array(
			Nette\PhpGenerator\Helpers::createObject('Ublaboo\ApiRouter\ApiRoute', array(
				'onMatch' => NULL,
				"\x00Ublaboo\\ApiRouter\\ApiRoute\x00presenter" => 'ApiRouter',
				"\x00Ublaboo\\ApiRouter\\ApiRoute\x00actions" => array(
					'POST' => FALSE,
					'GET' => 'read',
					'PUT' => FALSE,
					'DELETE' => FALSE,
				...
				"\x00Ublaboo\\ApiRouter\\ApiRoute\x00default_actions" => array(
					'POST' => 'create',
					'GET' => 'read',
					'PUT' => 'update',
					'DELETE' => 'delete',
				...
				"\x00Ublaboo\\ApiRouter\\ApiRoute\x00formats" => array(
					'json' => 'application/json',
					'xml' => 'application/xml',
				),
				"\x00Ublaboo\\ApiRouter\\ApiRoute\x00placeholder_order" => array(),
				"\x00*\x00description" => NULL,
				"\x00*\x00path" => '/api-router/api/users/<id>[/<limit>-<offset>]',
				"\x00*\x00method" => 'GET',
				"\x00*\x00parameters" => array(),
				"\x00*\x00parameters_infos" => array(
					'requirement',
					'type',
					'description',
					'default',
	...
	/**
	 * @return App\Presenters\ApiRouterPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\ApiRouterPresenter;
	...
	/**
	 * @return App\ResourcesModule\Presenters\ApiRouterPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\ResourcesModule\Presenters\ApiRouterPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\uplaboo\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\uplaboo\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\uplaboo\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_84d4dd5709_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\uplaboo\app/../temp/cache/latte');
...
final class Container_84d4dd5709_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_84d4dd5709 $container)
	{
